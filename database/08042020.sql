...
INSERT INTO `infosystem` (`id`, `address`, `contactno`, `email`, `shopname`, `writer`, `aboutus`) VALUES
(1, 'address', '601231868', 'mail@com', 'ANNE LIPPIE HOUSE', 'Izwan', 'Contrary to popular belief, Lorem Ipsum is simply random text. It has roots in a piece of classical Latin literature from 45 BC, maki years old.');
...
(1, 'Produk 2', 'details dekat sini ye', 'PRD20200403081859.jpg', 'bs', '600', 1);
