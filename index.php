            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="logo">
                            <a href="./index.html" style="font-family: 'Squada One', cursive;font-size:22px;color:black;letter-spacing:2px">
                                ANNE LIPPIE HOUSE
                            ...
                            <li class="cart-icon"><a href="#">
                                ...
                                <div class="cart-hover">
                                    <div class="select-button">
                                        <a href="#" class="primary-btn view-card">My Profile</a>
                                        <a href="#" class="primary-btn checkout-btn">LOG OUT</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
